...
FEATURE_KEYS: list[str] = [
    ...
    "left_pupil_to_inner_x",
    "left_pupil_to_inner_y",
    "left_pupil_to_outer_x",
    "left_pupil_to_outer_y",
    "right_pupil_to_inner_x",
    "right_pupil_to_inner_y",
    "right_pupil_to_outer_x",
    "right_pupil_to_outer_y",
